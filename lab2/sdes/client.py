...
def main():
    ...
    encrypted_bits = string_to_bits(encrypted)
    key_bits = string_to_bits(key)
    
    decrypted = sdes_decrypt(encrypted_bits, key_bits)
    decrypted_str = bits_to_string(decrypted)
    
    print("Decrypted (original) message:", decrypted_str)
